package 
{
	public class Variables
	{
		...
		public static var UPGRADE_COST_GUN_V:int						= 100;
		public static var UPGRADE_COST_CRIT_X3:int						= 100;
		public static var UPGRADE_COST_CRIT_CHANCE:int					= 100;
		public static var UPGRADE_COST_GUN_ADD_TOOL:int					= 150;
		
		public static var UPGRADE_COST_SWARM_III:int					= 50;
		public static var UPGRADE_COST_SWARM_V:int						= 100;
		
		public static var UPGRADE_COST_FREEZE_III:int					= 50;
		public static var UPGRADE_COST_FREEZE_V:int						= 100000000;
		
		public static var UPGRADE_COST_LAUNCHER_III:int					= 50;
		public static var UPGRADE_COST_LAUNCHER_V:int					= 100000000;
		
		CONTINIUM public static var ADDITIONAL_TOOL_GUN_BUYED:Boolean				= false;
